...
fun DiceRollerApp() {
    DiceWithButtonAndImage(
        modifier = Modifier
            ...
            .wrapContentSize(Alignment.Center) // Alinea el contenido al centro
    )
}

@Composable
fun DiceWithButtonAndImage(modifier: Modifier = Modifier) {
    var result by remember { mutableIntStateOf(1) } // Almacena el resultado del lanzamiento del dado
